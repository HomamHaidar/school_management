...
class ParentsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $my_parents->Name_Father = ['en' => 'ALi', 'ar' => 'علي'];
        ...
        $my_parents->Nationality_Mothers_id = Nationalitie::all()->unique()->random()->id;
        $my_parents->Blood_Type_Mothers_id =Type_Blood::all()->unique()->random()->id;
        $my_parents->Religion_Mothers_id = Religion::all()->unique()->random()->id;
