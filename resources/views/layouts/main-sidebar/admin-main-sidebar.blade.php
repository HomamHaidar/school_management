<div class="scrollbar side-menu-bg" style="overflow: scroll">
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
            ...
            <ul id="students-menu" class="collapse">
                ...
                <li>
                    ...
                    <ul id="Students_upgrade" class="collapse">
                        ...
                        <li> <a href="{{route('Promotions.create')}}">{{trans('main_trans.Promotions_list')}}</a> </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul id="Graduate students" class="collapse">
                        ...
                        <li> <a href="{{route('Graduated.index')}}">{{trans('main_trans.Graduate_list')}}</a> </li>
                    </ul>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Teachers-menu" class="collapse" data-parent="#s idebarnav">
        ...
        <li>
            ...
            <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Fees.index')}}">  {{trans('Students_trans.Study_Fees_List')}}</a> </li>
                <li> <a href="{{route('Fees_invoices.index')}}">{{trans('Students_trans.fee_invoice')}}</a> </li>
                <li> <a href="{{route('Receipt_Students.index')}}">  {{trans('Students_trans.fee')}}  </a> </li>
                <li> <a href="{{route('Processing_Fee.index')}}">{{trans('Students_trans.Fee_refund')}}</a> </li>
                <li> <a href="{{route('Payment_Students.index')}}">{{trans('Students_trans.Bills_of_exchange')}}</a> </li>
            </ul>
        ...
        <li>
            ...
            <ul id="Attendance-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Attendance.index')}}">{{trans('Students_trans.Attendance')}}</a> </li>
        ...
        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#Subjects">
                <div class="pull-left"><i class="fas fa-book-open"></i><span class="right-nav-text">{{trans('Students_trans.Subjects')}}</span></div>
                <div class="pull-right"><i class="ti-plus"></i></div>
                <div class="clearfix"></div>
            </a>
            <ul id="Subjects" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Subjects.index')}}"> {{trans('Students_trans.List_of_subjects')}}</a> </li>
            </ul>
        ...
        <li>
            ...
            <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Quizzes_admin.index')}}">{{trans('Students_trans.Quizzes')}}</a> </li>
                <li> <a href="{{route('Question_admin.index')}}">{{trans('Students_trans.Questions')}}</a> </li>
        ...
        <li>
            ...
            <ul id="library-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Library.index')}}">{{trans('main_trans.library')}}</a> </li>
        ...
        {{--                            <li> <a href="{{route('Online_Class.index')}}">اتصال مباشر زوم</a> </li>--}}
