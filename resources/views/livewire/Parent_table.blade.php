...
<button class="btn btn-success btn-sm btn-lg " wire:click="showformadd" type="button">{{ trans('Parent_trans.add_parent') }}</button><br><br>
<div class="table-responsive">
    ...
    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
        ...
        <tr class="table-success">
            ...
            <th>{{ trans('Parent_trans.Job_F') }}</th>
        ...
        @foreach ($my_parents as $my_parent)
            <tr>
                ...
                <td>{{ $i }}</td>
                <td>
                    <a style="color:green" wire:click="show({{$my_parent->id}})"  title="{{ trans('Parent_trans.click_to_show') }}">{{ $my_parent->email }}</a>
