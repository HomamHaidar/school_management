                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('grade.destroy', 'test') }}" method="post">
                                                ...
                                                <input id="id" type="hidden" name="id" class="form-control"
                                                       value="{{ $Grade->id }}">
                                                <br>
                                                <input class="form-control" name="Name" id="Name" type="text" readonly value="{{$Grade->Name}}">
                            ...
                            <div class="row">
                                <div class="col">
                                    <label for="Name" class="mr-sm-2">{{ trans('Grades_trans.stage_name_ar') }}
                                        :</label>
                                    <input id="Name" type="text" name="Name" class="form-control"  autocomplete>
                                </div>
                                <div class="col">
                                    <label for="Name_en" class="mr-sm-2">{{ trans('Grades_trans.stage_name_en') }}
                                        :</label>
                                    <input type="text" class="form-control" name="Name_en"  autocomplete>
                                </div>
                            </div>
                            <div class="form-group">
