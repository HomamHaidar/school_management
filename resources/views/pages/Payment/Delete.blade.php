    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('Students_trans.Delete_Bills_of_exchange')}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('Payment_Students.destroy','test')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{trans('Students_trans.Delete_sure')}}</h5>
