            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{ route('Question_admin.update','test') }}" method="post" autocomplete="off">
                                @method('PUT')
                                @csrf
                                <div class="form-row">

                                    <div class="col">
                                        <label for="title">{{trans('Students_trans.The_Question')}}</label>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">{{trans('Students_trans.Right_answer')}}</label>
                                ...
                                <div class="form-row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="Grade_id">{{trans('Students_trans.Quiz_name')}} <span
