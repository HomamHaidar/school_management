            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('Quizzes_admin.create')}}" class="btn btn-success btn-sm" role="button"
                                   aria-pressed="true">{{trans('Students_trans.Add_Quizzes')}}</a><br><br>
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            <th>#</th>
                                            <th>{{trans('Students_trans.Quizzes_list')}}</th>
                                        ...
                                        @foreach($quizzes as $quizze)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('Quizzes_admin.edit',$quizze->id)}}"
                                            ...
                                            <div class="modal fade" id="delete_exam{{$quizze->id}}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <form action="{{route('Quizzes_admin.destroy','test')}}" method="post">
                                                        {{method_field('delete')}}
                                                        {{csrf_field()}}
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p> {{ trans('Students_trans.Delete_sure') }}</p>
