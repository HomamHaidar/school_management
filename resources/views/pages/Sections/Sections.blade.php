                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            @foreach($list_Sections->teachers as $teacher)
                                                                                <option selected
                                                                                        value=" {{$teacher['id']}}">
                                                                                    - {{ trans('Sections_trans.Teacher') }} {{$teacher->Name}} {{$teacher->specializations->Name}} </option>
                                                                            @endforeach
                                                                        </td>
                                                                    </tr>
                                                                                        ...
                                                                                        <div class="col">
                                                                                            <div class="form-check">
                                                                                                ...
                                                                                                <label
                                                                                                    ...
                                                                                                    for="exampleCheck1">{{ trans('Sections_trans.Status') }}</label><br><br>
                                                                                                ...
                                                                                                <div class="form-check">
                                                                                                    ...
                                                                                                    @foreach($teachers as $teacher)
                                                                                                        ...
                                                                                                        <label
                                                                                                            ...
                                                                                                            {{$teacher->Name}}  {{$teacher->specializations->Name}} </label>
                                                                                                        <br>
                                                                                                    @endforeach
                                                                                                </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="{{ route('Sections.store') }}" method="POST">
                                            ...
                                            <div class="form-check">
                                                    ...
                                                    <br>
                                                    @foreach($teachers as $teacher)
                                                        <input multiple name="teacher_id[]" id="exampleFormControlSelect2"
                                                               class="form-check-input" type="checkbox" value="{{$teacher->id}}"
