                    ...
                    <form enctype="multipart/form-data" method="post" action="{{route('Setting.update','test')}}">
                        ...
                        <div class="row">
                            <div class="col-md-6 border-right-2 border-right-blue-400">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label font-weight-semibold">{{trans('Settings.shortcut_school_name')}}</label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label font-weight-semibold">{{trans('Settings.End_of_the_first_term')}}</label>
                                    <div class="col-lg-9">
                                        <input name="end_first_term" value="{{ $setting['end_first_term'] }}" type="text" class="form-control date-pick" placeholder="Date Term Ends">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label font-weight-semibold">{{trans('Settings.End_of_the_second_term')}}</label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label font-weight-semibold">{{trans('Settings.School_logo')}}</label>
                                    <div class="col-lg-9">
                                        <div class="mb-3">
