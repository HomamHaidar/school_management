            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post"  action="{{ route('Students.store') }}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                            <h5 style="font-family:'Cairo', sans-serif;color: green">{{trans('Students_trans.personal_information')}}</h5><br>
                        ...
                        <h5 style="font-family: 'Cairo', sans-serif;color: green">{{trans('Students_trans.Student_information')}}</h5><br>
