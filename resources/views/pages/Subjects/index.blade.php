...
@section('css')
    ...
    @section('title')
        {{trans('Students_trans.List_of_subjects')}}
    @stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                                                    ...
                                                    <form action="{{route('Subjects.destroy','test')}}" method="post">
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('Students_trans.Delete_subject')}}</h5>
