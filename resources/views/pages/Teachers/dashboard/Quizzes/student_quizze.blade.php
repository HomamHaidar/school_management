...
@section('css')
    ...
    @section('title')
        {{trans('Students_trans.Examined_students')}}
    @stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($degrees as $degree)
                                            <tr>
                                                ...
                                                <td>
                                                    {{$degree->question->title}}
                                                </td>
                                                <td>{{$degree->score}}</td>
                                                @if($degree->abuse == 0)
                                                    <td style="color: green">{{trans('Students_trans.no_manipulation')}}</td>
                                                @else
                                                    <td style="color: red">{{trans('Students_trans.yes_manipulation')}}</td>
                                                @endif
                                                <td>{{$degree->date}}</td>
                                                <td>
                                                    @if($degree->abuse == 1)
