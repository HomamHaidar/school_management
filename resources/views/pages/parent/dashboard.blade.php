            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <h2 class="mb-0 text-success" >
                        {{trans('main_trans.Welcome')}} <span >{{auth()->user()->Name_Father}}</span>
                    </h2>
                </div>
                <br>
                <br>
                        ...
                        <div class="col-md-8 col-lg-6 col-xl-4">
                            <a href="">
                                <div class="card text-black">
                                    ...
                                    @if($son->gender->Name=="Male" or $son->gender->Name=="ذكر")
                                    <img src="{{URL::asset('assets/images/male_son.png')}}"/>
                                    @else
                                        <img src="{{URL::asset('assets/images/female _student.png')}}"/>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <span>{{$son->grade->Name}}</span>
                                            </div>
                                            <div class="d-flex justify-content-between">
                                                <span>{{trans('Students_trans.Classroom')}}</span><span>{{$son->classroom->Name_Class}}</span>
                                            </div>
                                            <div class="d-flex justify-content-between">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                    @if(\App\Models\Degree::where('student_id',$son->id)->count() == 0)
                                                        <span>{{trans('Students_trans.quizz_number')}}</span><span
